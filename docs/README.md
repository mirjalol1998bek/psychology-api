...
Bu papka — loyihaning **birlamchi manbai**. Kod bilan ziddiyatda bo'lsa,
shu yerdagi hujjat to'g'ri hisoblanadi. O'zgarish tartibi: **hujjat → kod**.
...
- [x] [`observation-card.md`](observation-card.md) — 10-metodika (tyutor to'ldiradigan kuzatuv kartasi)
